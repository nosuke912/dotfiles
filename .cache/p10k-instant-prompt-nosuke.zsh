() {
  ...
  [[ -t 0 && -t 1 && -t 2 && $ZSH_VERSION == 5.4.2 && $ZSH_PATCHLEVEL == ubuntu/5.4.2-3ubuntu3.1 &&
  ...
  local cr=$'\r' lf=$'\n' esc=$'\e[' rs=$'\x1e' us=$'\x1f'
  local -i height=1
  local prompt_dir=/home/nosuke/.cache/p10k-nosuke
